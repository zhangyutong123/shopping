...
<div class="soubg">
    @if(session('home_login'))
       <div class="sou">
        ...
        <span class="fr">
            <span class="fl">
               <span>欢迎您 ! {{session('home_userinfo')->uname}}</span>
...
<div class="top">
    <div class="logo" style="width: 220px; height: 120px; margin-top: 15px;">
        <a href="/">
    ...
    <div class="i_car">
    	<div class="car_t"><a href="/home/cart">购物车 [ <span>3</span> ]</a></div>
    </div>
</div>