...
//购物车中增加数量路由
Route::post('/home/car/car1','Home\CartController@car1');
//清空购物车
Route::get('/home/car/clear','Home\CartController@clear');
//购物车提交订单
Route::get('/home/car/confirm','Home\CartController@confirm');
